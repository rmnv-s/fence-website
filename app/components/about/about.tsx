                ...
                <section className="grid grid-cols-1 md:grid-cols-2 items-center py-80 gap-24 max-[475px]:py-12 max-[475px]:gap-0">
                    ...
                    <div>
                        ...
                        <p className="text-black text-[2.1rem] leading-[3.5rem] font-normal max-[995px]:text-m max-[995px]:leading-[2.5rem] max-[475px]:text-base">
                            Компания "Стальной Узор" – это источник надежности и профессионализма в
                            мире установки заборов. Мы специализируемся на создании и установке
                            качественных заборов под ключ, которые не только обеспечивают
                            безопасность и конфиденциальность, но и придают вашему пространству
                            неповторимый характер и стиль.
                        </p>
                    </div>
                </section>
            </Wrapper>
