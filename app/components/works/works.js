        ...
        <Wrapper>
          ...
          <div className="relative">
            ...
            <Slider {...settings} ref={(s) => setSwiper(s)}>
              ...
              <div>
                <Image className="object-contain w-full" src={img5} alt="картинка" />
              </div>
              <div>
                <Image className="object-contain w-full" src={img6} alt="картинка" />
              </div>
              <div>
                <Image className="object-contain w-full" src={img7} alt="картинка" />
              </div>
              <div>
                <Image className="object-contain w-full" src={img8} alt="картинка" />
              </div>
              <div>
                <Image className="object-contain w-full" src={img9} alt="картинка" />
              </div>
              <div>
                <Image className="object-contain w-full" src={img10} alt="картинка" />
              </div>
              <div>
                <Image className="object-contain w-full" src={img11} alt="картинка" />
              </div>
              <div>
                <Image className="object-contain w-full" src={img12} alt="картинка" />
              </div>
            </Slider>
          </div>
        </Wrapper>
