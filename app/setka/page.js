                    ...
                    <section className="mt-60 mb-40">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <p className="text-l leading-[3.2rem] mb-28 col-start-1 col-end-2">
                                Заборы из 3D панелей используются для ограждения садовых участков,
                                детских площадок, теннисных кортов, административных зданий.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-24">
                            ...
                            <ul className="list-disc ml-6 text-m font-bold leading-[3rem] md:text-l">
                                Панельные ограждения изготавливаются из сварной сетки — оцинкованной
                                или с полимерным напылением. Благодаря V- образному рифлению
                                проволок достигается эффект объема, обеспечивается конструкционная
                                жесткость секций.
                                <li className="text-m font-medium ml-8 mt-8 mb-4">
                                    3 мм — временные, подходят для установки вокруг стройплощадок
                                </li>
                                <li className="text-m font-medium ml-8 mt-8 mb-4">
                                    4 мм — надежные/стандарт, используются для спортплощадок, школ,
                                    детских садов, дачных участков, загородных домов
                                </li>
                                <li className="text-m font-medium ml-8 mt-8 mb-4">
                    ...
                    <section className="mt-60 mb-60">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <p className="text-l leading-[3.2rem] mb-28 col-start-1 col-end-2">
                                ...
                                участков. Они отличаются надежностью, прочностью, не создают тени,
                                не мешают свободному прохождению воздуха
                            </p>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-24">
                            <ul className="list-disc ml-6 text-m font-bold leading-[3rem] md:text-l">
                                Забор из рабицы представляет собой вертикальные опоры с растянутой
                                между ними сеткой. Каждая опора оснащена 4 крюками, которые идут
                                сверху вниз на одинаковом расстоянии друг от друга. Крючки нужны для
                                навешивания и фиксации полотна.
                                <li className="text-m font-medium ml-8 mt-8 mb-4">
                                ...
                                <li className="text-m font-medium ml-8 mt-8 mb-4">
                                    С двумя протяжками. В этом случае используется два ряда стальной
                                    арматуры. Она проходит на расстоянии 15-30 см от верхнего и
                                    нижнего края сетки.
                                </li>
                            </ul>
                            <Image
