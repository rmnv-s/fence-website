          ...
          <section className='mt-60 mb-60'>
            <div className='grid grid-cols-1 md:grid-cols-2'>
              ...
              <p className='text-l leading-[3.2rem] mb-28 col-start-1 col-end-2'>
                Производят их из листовой стали и окрашивают в самые разные
                цвета. Прочность такой изгороди пропорциональна количеству ребер
                жесткости, выдавленных на станке, и глубине профилирования.
              </p>
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-x-24 mt-40 mb-40'>
              ...
              <ul className='list-disc ml-6 text-l font-bold leading-[3rem] col-start-1 col-end-'>
                ...
                <li className='text-m font-medium ml-8 mt-8 mb-4'>
                  ...
                  сечения, а по краям имеет плоскости, которые усиливают
                  жесткость планок.
                </li>
              </ul>
            </div>
            ...
            <p className='text-m max-w-[80rem] text-center leading-[2.8rem] m-auto '>
              Заборы из металлического штакетника пользуются большой
              популярностью у владельцев дачных домов, коттеджей в черте города.
              Причиной высокого спроса на заборы из металлоштакетника являются
              хорошие механические характеристики и отличные декоративные
              качества.
            </p>
          </section>
        </Wrapper>
