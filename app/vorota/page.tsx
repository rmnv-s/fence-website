                    ...
                    <section className="mt-60 mb-60">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <p className="text-m leading-[3.2rem] mb-28 col-start-1 col-end-2 sm:text-l">
                                Ворота этого типа, с калиткой или без нее, можно увидеть на дачных
                                участках, территориях загородных домов, складских и коммерческих
                                помещений, объектов промышленного назначения. Откатные ворота для
                                дачи или коттеджа открывают проем для въезда машины путем сдвигания
                                створки вбок. Установка автоматики позволяет сделать ворота более
