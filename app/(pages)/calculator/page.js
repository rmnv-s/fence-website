  ...
  return (
    <>
      <div className='bg-black'>
        <Wrapper>
          <div className='grid grid-cols-1 min-h-[100vh] gap-24 justify-end items-center sm:grid-cols-2 gap-8'>
            <div className='mt-[150px]'>
              ...
              <p className='text-whiteFont text-l leading-[3.2rem] max-w-[52.9rem] mb-20 max-[320px]:text-[1.8rem]'>
                Онлайн-расчет может оценить примерную стоимость всей
                конструкции. Это удобный способ быстро узнать стоимость по Вашим
                параметрам.
              </p>
            </div>
