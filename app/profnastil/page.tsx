...
import SvgPhohIconYellow from '@/app/components/assets/phone-yellow.icon';
                ...
                <div className="flex items-center justify-start h-full max-w-100  m-auto px-10">
                    <div className="relative mb-60 max-[560px]:mb-0 mt-[150px]">
                        ...
                        <p className="text-whiteFont text-m leading-[3.2rem] max-w-[52.9rem] mb-20 max-[320px]:text-[1.8rem]">
                            Забор из профнастила состоит из: <br /> Столбы, как правило это
                            профильная труба 60 на 60 мм, лаги – профильная труба сечением 40 на 20
                            мм, профлист.
                        </p>
                        <Button
                    ...
                    <section className="mt-60">
                        <div className="">
                            ...
                            <p className="text-m mb-28">
                                Профнастил (профлист) – это оцинкованный лист толщиной от 0,4 до 1,0
                                мм, покрыт полиэстером.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 items-center gap-24 sm:grid-cols-2">
                            ...
                            <p className="text-l leading-[3.5rem]">
                                Самым распространненым вариантом для забора из профнастила является
                                профлист с односторонним покрытием, с высотой листа 2 метра.
                            </p>
                            <Image
                                className=""
                                alt="описание штакетников"
                    ...
                    <Wrapper>
                        <div className="grid grid-cols-1 sm:grid-cols-2 items-center pt-9">
                            <div>
                                ...
                                <Link
                                    className="flex text-yellow text-xl"
                ...
                <Wrapper>
                    <section className="my-60">
                        ...
                        <div className="grid grid-cols-1 gap-24 text-whiteFont mb-60 sm:grid-cols-2">
                            <div className="bg-black py-16 px-12 ">
                                <ul className="list-disc ml-6 text-l font-bold mb-12">
                                    ...
                                    <li className="text-m font-medium ml-8">
                                        более эстетичный вид по сравнению с обычным деревянным
                                        забором
                                    </li>
                                </ul>
                                <p className="text-l leading-[3.5rem]">
                                    Такой забор обязательно понравится тем, кто желает защитить свой
                                    участок от посторонних глаз соседей.
                                </p>
                            </div>
                            ...
                            <div className="bg-black py-16 px-12">
                                <ul className="list-disc ml-6 text-l font-bold leading-[3rem]">
                                    ...
                                    <li className="text-m font-medium ml-8 mt-8 mb-4">
                                        {' '}
                                        уступает по красоте забору из металлического штакетника и,
                                        конечно, секционному забору с элементами ковки;{' '}
                                    </li>
                                    <li className="text-m font-medium ml-8">
                                        низкая светопропускаемость и продуваемость, что при
                                        определенном географическом положении может приводить к
                                        заболачиванию огораживаемой территории.
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <p className="text-m max-w-[80rem] text-center leading-[2.8rem] m-auto ">
                            Во многих садовых товариществах запрещается установка сплошных (не
                            просматриваемых) заборов между соседними примыкаемыми участками (межевые
                            заборы), в этом случае забор из профнастила не приемлем, в остальном
                            данный забор сочетает прекрасные эксплуатационные качества и
                            отностительно небольшую стоимость.
                        </p>
                    </section>
                </Wrapper>
            </main>
